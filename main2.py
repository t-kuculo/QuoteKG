...
if __name__ == "__main__":
    ...
    #getEmbeddings()
    #print(4)
    #assignEmbeddings(entity_dir = "/home/kuculo/quotekg/v3/", embedding_dir ="/home/kuculo/quotekg/embeddings/")
    #print(5)
    #smallTest2()
    #splitEntitiesByLanguage()
    #path ="/home/kuculo/quotekg/v4/Q7186.pkl"
    ...
    sim = 0.8
    """
    #for sim in [0.8]:#5,0.75,0.65]:#,0.6,0.55,0.5]:
        #if sim ==0.8:
            #counter = Counter()                                                           
            #for i, subdir in enumerate(subdirs):  
                #print("%d of %d complete"%(i, len(subdirs)))
