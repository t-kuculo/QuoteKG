...
current_date = (2021, 12, 6)  # this needs to be synchronised with erroneous results from datefinder (yyyy, mm,dd)
...
pkl_file = "corpus.pkl"
wikiquote_to_wikidata_filename = "wikiquote_to_wikidata.tsv"
